...
const NavBar = () => {
  ...
  return (
   <header className="font-bold sticky top-4 left-0 right-0 mx-auto min-h-14 w-[92%] sm:w-[85%] md:w-[70%] lg:w-[60%] z-50 flex items-center justify-center rounded-2xl bg-white/[0.06] backdrop-blur-2xl border border-white/15 ring-1 ring-white/10 shadow-[0_0_25px_-5px_rgba(255,255,255,0.05)] text-white px-3 sm:px-6 py-2">
